...
Given an array, X, of  integers and an array, F, representing the respective frequencies of X's elements, construct a data set, S', where each x1  occurs at frequency . Then calculate and print S's interquartile range, rounded to a scale of 1 decimal place (i.e., 12.3 format).
“””
n = int(raw_input())
